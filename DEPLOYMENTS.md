...
- Indexer service: superseded for Solana by direct RPC reads (`useSolanaSkills`) + `solana/scripts/indexer.mjs`; the legacy Solana `indexer/` is not deployed for Solana.
