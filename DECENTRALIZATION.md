...
- **Atomic cascade refunds** — a missed deadline lets *anyone* permissionlessly `expire_node`;
...
mechanically checkable. Only *subjective quality* rulings rest with the facilitator in v1.
